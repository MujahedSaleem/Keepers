...
function App() {
  ...
  let mobile = matchMedia("max-width:570px");
              ...
              <div className="col-lg-4 col-md-6">
                <div className="bottom-arrow">
                  <p>
                    ...
                    and exciting partnership launch in Austria. We know that
                    with your support, together we can help protect kids as they
                    find their independence in the digital world.
                  </p>
                </div>
            ...
            <div className="centerRow row" style={{ marginTop: "28px" }}>
              ...
              <div className="col-md-7">
                <p>
                  ...
                  when they’re on the go. Create a safe zone for tracking kids
                  and get alerts when they break the planned zone.
                </p>
              </div>
            </div>
            <div className="centerRow row" style={{ marginTop: "28px" }}>
